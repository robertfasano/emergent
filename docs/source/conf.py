...
MOCK_MODULES = ['numpy', 'pandas', 'PyQt5', 'PyQt5.QtCore','scipy', 'matplotlib', 'sklearn', 'time']
...
latex_documents = [
    (master_doc, 'labAPI.tex', 'labAPI Documentation',
...
man_pages = [
    (master_doc, 'labapi', 'labAPI Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'labAPI', 'labAPI Documentation',
     author, 'labAPI', 'One line description of project.',
     'Miscellaneous'),
]

...
class LabJack():
    ...
    def SPI(self, CS, CLK, MISO, MOSI):
        ...
        ljm.eWriteName(self.handle, "SPI_MODE", 3)                  # Selecting Mode CPHA=1 (bit 0), CPOL=1 (bit 1)
        ...
        ljm.eWriteNameByteArray(self.handle, "SPI_DATA_TX", len(dataWrite), dataWrite)
